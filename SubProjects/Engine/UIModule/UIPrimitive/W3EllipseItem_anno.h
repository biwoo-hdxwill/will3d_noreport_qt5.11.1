...
File:			class CW3EllipseItem_anno
Language:		C++11
...
class UIPRIMITIVE_EXPORT CW3EllipseItem_anno : public QObject, public QGraphicsEllipseItem
{
	Q_OBJECT
public:
	CW3EllipseItem_anno(const QPointF point);
	~CW3EllipseItem_anno();
...
signals:
	void sigTranslateCircle(QPointF);
	void sigOnHover(bool);
