...
namespace lang
{
	...
	void LanguagePack::Init(void)
	{
		...
		case LanguageID::RU:
			...
			break;
		case LanguageID::JA:
			common::Logger::instance()->Print(common::LogType::INF, "Language : Japanese");
			qm_path = "./language/common_ja_JP.qm";
			break;
		case LanguageID::DE:
			common::Logger::instance()->Print(common::LogType::INF, "Language : Deutsch");
			qm_path = "./language/common_de.qm";
			break;
		case LanguageID::PL:
			common::Logger::instance()->Print(common::LogType::INF, "Language : Polish");
			qm_path = "./language/common_pl.qm";
			break;
		default:
			break;
		}
	...
	QString LanguagePack::txt_window_center() { return tr("Fixed Window Center"); }
	QString LanguagePack::txt_window_width() { return tr("Fixed Window Width"); }
  ...
  QString LanguagePack::txt_downloading() { return tr("Downloading..."); }
  QString LanguagePack::txt_download_progress() { return tr("Download Progress"); }
  QString LanguagePack::txt_install() { return tr("Install"); }
	...
	//20250210LIN
	QString LanguagePack::msg_94() { return tr("The implant files are not installed. Would you like to install them?"); }
  QString LanguagePack::msg_95() { return tr("Do you want to save this project?"); }
  QString LanguagePack::msg_96() { return tr("A new version is available. The download will now begin. If you cancel, the program will not run."); }
  QString LanguagePack::msg_97() { return tr("Please connect to the Internet and try again"); }
  QString LanguagePack::msg_98() { return tr("The internet connection has been lost. Please check and try again."); }
  QString LanguagePack::msg_99() { return tr("Download could not be completed. Please try again."); }
}
