...
RLUTIL_INLINE void clear_screen(void) {
#if defined(_WIN32) && !defined(RLUTIL_USE_ANSI)
...
RLUTIL_INLINE void setString(RLUTIL_STRING_T str) {
	...
	/// #160711 resolved bug
	/// https://github.com/tapio/rlutil/issues/33
	/// http://stackoverflow.com/questions/18959551/what-is-character-set-in-visual-studio
	/// QtLibrary, QtApplication predefine UNICODE
	/// So, you need use LPCWSTR(str) rather than LPCSTR(str)
